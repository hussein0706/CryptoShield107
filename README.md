...
## 🔐 How it works
1. The app monitors the `/sdcard/Download` directory.
2. When a new file is detected, it is immediately encrypted with a predefined key.
3. Users can trigger the `decryptFolder` function to restore original file access.
